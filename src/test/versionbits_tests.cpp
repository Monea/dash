...
BOOST_AUTO_TEST_CASE(versionbits_computeblockversion)
{
    ...
    BOOST_CHECK_EQUAL(ComputeBlockVersion(lastBlock, mainnetParams, 4) & (1<<bit), 0);
    ...
    BOOST_CHECK((ComputeBlockVersion(lastBlock, mainnetParams, 4) & (1<<bit)) != 0);
    // and should also be using the VERSIONBITS_TOP_BITS.
    BOOST_CHECK_EQUAL(ComputeBlockVersion(lastBlock, mainnetParams, 4) & VERSIONBITS_TOP_MASK, VERSIONBITS_TOP_BITS);
