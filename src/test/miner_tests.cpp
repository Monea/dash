...
BOOST_AUTO_TEST_CASE(CreateNewBlock_validity)
{
    ...
    BOOST_CHECK(pblocktemplate = CreateNewBlock(chainparams, scriptPubKey, ALGO_YESCRYPT));
    ...
    BOOST_CHECK_THROW(CreateNewBlock(chainparams, scriptPubKey, ALGO_YESCRYPT), std::runtime_error);
    mempool.clear();
